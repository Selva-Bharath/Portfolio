...
const Register = () => {
  ...
  return (
    <div className="scroll-smooth lg:scroll-smooth">
      ...
      {project ? (
        <div className="w-100 h-210 border bg-white ml-50 relative top-[-380px] shadow-2xl">
        ...
        <div className="relative top-[440px] ml-75 fixed">
          <button
